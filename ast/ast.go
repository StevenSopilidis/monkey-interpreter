...
// sturct that represents a call to a function (<expression>(<comma separated expressions>))
...
// struct that represents IndexExpression (<expression>[<expression>])
...
// struct that represents a HashMap
...
// struct that represents an array
...
// struct that represents a function (fn <params> <block_statement>)
...
// struct that represents a block of statements
...
// struct that represents if-else expressions (if(<condition>)<consequence>else<alternative>)
